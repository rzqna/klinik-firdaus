...
@section('content')
    <main id="content" class="p-6 pt-20 lg:pt-6 lg:ml-64 min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold mb-6 text-gray-800">Tambah Data Kriteria</h2>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Panggil saat halaman dimuat (untuk nilai old() jika ada validasi gagal)
            calculateSecondaryFactor();

            // Panggil setiap kali input Core Factor berubah
            bobotCoreFactorInput.addEventListener('input', calculateSecondaryFactor);
        });
    </script>
@endsection
