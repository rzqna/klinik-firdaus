@extends('layouts.main') {{-- Menggunakan layout utama yang Anda miliki --}}

@section('content')
    {{-- div#content sudah ada di layouts.main, jadi tidak perlu diulang di sini --}}
    <main id="content" class="p-6 pt-20 lg:pt-6 lg:ml-64 min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold mb-6 text-gray-800">Edit Data Sub Kriteria</h2>
            ...
            <form action="{{ route('subkriteria.update', $subkriteria->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    {{-- Dropdown untuk Memilih Kriteria Induk --}}
                    <div class="mb-4">
                        <label for="kriteria_id" class="block text-sm font-medium text-gray-700 mb-2">Pilih Kriteria Induk:</label>
                        <select
                            id="kriteria_id"
                            name="kriteria_id"
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('subkriteria', $subkriteria->subkriteria) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            value="{{ old('nilai_ideal', $subkriteria->nilai_ideal) }}"
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="inline-flex items-center">
                                <input
                                    ...
                                    {{ old('factor_type', $subkriteria->is_core_factor ? 'core' : 'secondary') == 'core' ? 'checked' : '' }}
                                    required
                                >
                            ...
                            <label class="inline-flex items-center">
                                <input
                                    ...
                                    {{ old('factor_type', $subkriteria->is_core_factor ? 'core' : 'secondary') == 'secondary' ? 'checked' : '' }}
                                    required
                                >
                    ...
                    <div class="mb-6">
                        ...
                        >{{ old('keterangan', $subkriteria->keterangan) }}</textarea>
                        @error('keterangan')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
